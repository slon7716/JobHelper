...
//         resumeDiv.innerHTML = `<span class="resume-link">${profileData.basicData.resumeName}</span>`;
//       } else {
...
//   function initResumeHandler(profileData) {
...
//           `${API_URL}/api/resumes/${resumeId}/file`,
//           {
//             headers: { Authorization: `Bearer ${token}` }
//           }
//         );
